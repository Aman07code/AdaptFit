    ...
    return (
      <div className="p-8">
        ...
        <div className="glow-card rounded-2xl p-12 flex flex-col items-center justify-center text-center">
          <div className="w-16 h-16 bg-green-500/10 rounded-2xl flex items-center justify-center mb-4 float">
          ...
          <button onClick={() => navigate('/trainer')}
            className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-black transition-all pulse-glow"
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          [Dumbbell, 'Total sessions', history.length, 'text-green-400', 'bg-green-500/10'],
          [Clock, 'Total minutes', totalMinutes, 'text-blue-400', 'bg-blue-500/10'],
          [Flame, 'Calories burned', totalCalories, 'text-orange-400', 'bg-orange-500/10'],
        ].map(([Icon, label, value, color, bg]) => (
          <div key={label} className="glow-card shimmer rounded-2xl p-5">
        ...
        <div className="glow-card shimmer rounded-2xl p-6">
          ...
          {hasWeeklyData ? (
            ...
            <div className="h-[180px] flex flex-col items-center justify-center text-center">
              ...
              <button onClick={() => navigate('/trainer')} className="text-xs text-green-400 mt-2 hover:text-green-300">
                Start one now →
              </button>
            </div>
          )}
      ...
      <div className="gradient-border rounded-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs text-green-400">{totalMinutes} total mins</p>
          </div>
        </div>
              ...
              <div className="flex items-start justify-between mb-2">
                <div>
                  ...
                  <div className="flex items-center gap-3 text-xs text-white/40 mt-1">
                    ...
                    <span className="bg-white/5 px-2 py-0.5 rounded-full">{h.workoutType}</span>
                  </div>
                </div>
